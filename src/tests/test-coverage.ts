...
export const TEST_STRATEGY = [
  ...
  '7. Options coverage: array policy matrix, arrayEquality, keysToSkip, trackCircularReferences.',
  '   Covered in diff.options.test.ts (keysToSkip, trackCircularReferences).',
  '   Array policy matrix + arrayEquality are covered in diff.arrays.test.ts.'
] as const;
